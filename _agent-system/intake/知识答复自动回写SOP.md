...
7. 专题优先（命中专题关键词时）：
- 先回写专题总控：`_agent-system/topics/`
- 再回写部门知识位点
- 当前启用专题：`[[_agent-system/topics/香港新资本投资者入境计划-专题总控]]`
...
6. 若命中专题，必须在专题总控的“专题资料池”或“跨部门执行入口”补充回链。
7. 更新 frontmatter 中 `updated` 日期。
8. 回写完成后按 `[[_agent-system/intake/Git同步SOP]]` 标记本轮是否命中同步触发条件。
